...
# shape_optimization_dir = os.path.dirname(current_dir)
# fem_level_set_opt_dir = os.path.dirname(shape_optimization_dir)
# sys.path.append(fem_level_set_opt_dir)
# project = os.path.dirname(fem_level_set_opt_dir)
...
sources = spyro.create_transect((-0.01, 0.01), (-0.01, 0.99), 2)
