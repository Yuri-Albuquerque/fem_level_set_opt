...
static void form0_cell_integral_otherwise(double *__restrict__ A, double const *__restrict__ coords, double const *__restrict__ w_0, double const *__restrict__ w_1, double const *__restrict__ w_2, double const *__restrict__ w_3)
{
  ...
  for (int32_t ip = 0; ip <= 2; ++ip)
  {
    ...
    t19 = t19 + (t0 * (0.32768000000000014 * (t10 * t18 + t9 * t17) + 0.32768000000000014 * (t8 * t16 + t7 * t15)) + w_3[0]) * t12[ip] * t11;
  }
  {
    int32_t const j = 0;
...
void wrap_form0_cell_integral_otherwise(int32_t const start, int32_t const end, double *__restrict__ dat0, double const *__restrict__ dat1, double const *__restrict__ dat2, double const *__restrict__ glob0, double const *__restrict__ dat3, double const *__restrict__ dat4, int32_t const *__restrict__ map0, int32_t const *__restrict__ map1, int32_t const *__restrict__ map2)
{
  double t0[1];
  double t1[3 * 2];
  double t2[7 * 2];
  ...
  for (int32_t n = start; n <= -1 + end; ++n)
  {
    ...
    form0_cell_integral_otherwise(&(t0[0]), &(t1[0]), &(t2[0]), &(glob0[0]), &(t3[0]), &(t4[0]));
    {
      int32_t const i17 = 0;
