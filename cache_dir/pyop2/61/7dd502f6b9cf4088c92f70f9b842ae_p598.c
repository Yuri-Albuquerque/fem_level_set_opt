...
static void form0_interior_facet_integral_otherwise(double *__restrict__ A, double const *__restrict__ coords, double const *__restrict__ w_0, double const *__restrict__ w_1, double const *__restrict__ w_2, uint32_t const *__restrict__ facet)
{
  ...
  for (int32_t ip = 0; ip <= 1; ++ip)
  {
    ...
    t31 = t25 * 0.32768000000000014 * t30 + t24 * 0.32768000000000014 * t29;
    t32 = t15 * 0.32768000000000014 * t28 + t14 * 0.32768000000000014 * t27;
    t33 = t33 + (-1.0 * w_1[1] * 0.5 * (fabs(t31) + t31) + w_1[0] * 0.5 * (fabs(t32) + t32)) * t8[ip] * t7;
  }
  t34 = t33 * -1.0 * w_2[0];
  t35 = w_2[0] * t33;
  {
...
void wrap_form0_interior_facet_integral_otherwise(int32_t const start, int32_t const end, double *__restrict__ dat1, double const *__restrict__ dat2, double const *__restrict__ dat3, double const *__restrict__ dat4, double const *__restrict__ glob0, uint32_t const *__restrict__ dat0, int32_t const *__restrict__ map0, int32_t const *__restrict__ map1, int32_t const *__restrict__ map2)
{
  double t0[2];
  double t1[6 * 2];
  double t2[14 * 2];
  ...
  for (int32_t n = start; n <= -1 + end; ++n)
  {
    ...
    form0_interior_facet_integral_otherwise(&(t0[0]), &(t1[0]), &(t2[0]), &(t3[0]), &(glob0[0]), &(dat0[2 * n]));
    {
      int32_t const i15 = 0;
