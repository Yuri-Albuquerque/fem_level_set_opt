...
model = {}
model["parallelism"] = {
    "type": "automatic",  # options: automatic (same number of cores for every processor), custom, off
...
sources = spyro.create_transect((-0.01, 0.25), (-0.01, 2.750), 2)
