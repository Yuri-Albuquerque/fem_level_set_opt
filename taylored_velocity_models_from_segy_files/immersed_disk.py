...
img = 1.0 - \
    np.int64(mpimg.imread('./true/immersed_disk_true.png') == 0)[:, :, 0]
...
guess_mat = np.where(ellipse <= 0, 4500, 2000)
path_velocity, path_meshes, path_true, path_guess = (
    '../velocity_models/', '../meshes/', './true/', './guess/')

fname_guess = 'immersed_disk_guess_vp'
fname_true = 'immersed_disk_true_vp'
fname_back = 'immersed_disk_back_vp'
