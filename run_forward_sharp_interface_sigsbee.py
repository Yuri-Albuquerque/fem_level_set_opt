...
model["mesh"] = {
    ...
    "meshfile": "meshes/sigsbee2b_true3.msh",
...
sources = spyro.create_transect((-0.01, 4.0), (-0.01, 27.00), 3)
model["acquisition"] = {
    "source_type": "Ricker",
    ...
    "amplitude": 1.0,
    "num_receivers": 348,
    "receiver_locations": spyro.create_transect((-0.01, 4.00), (-0.01, 27.00), 348),
}
model["timeaxis"] = {
